...
`<br> <div class='background' style='padding: 0; background-color: white'>\
  ...
  <div class=\"background\">\
    ...
    <p>\"I apologize for helping a fellow slime keep their body together. What was the question?\" Doesn't sound so good now, does it? I can feel Airn's wicked grin behind me; Mina shakes her head next to her. My pupil is giving me a pleading look. They would rather be a puddle than be in this situation.</p>
    <p>\"Excuse me?\"</p>
    ...
    <p>\"You don't?\" Her eyes narrow, taking the bait. I have the sudden thought of Airn duelling Ms. Johann. It's not pretty.</p>
    ...
    <p>\"Every cell in your body is a physical manifestation of your mana. You take your magic and move it around, change it, and because it's part of a cell, the cell moves and changes with it. It's a very difficult style of magic for humans to replicate- we just don't have enough control to bind mana into more than a few cells at a time.\"</p>
...
var shortstory = [
  // send this to matt.valade@writtenoutloud.org
  ...
  <div class='background'>\
    ...
    <p>"Hmm... That's not a bad idea." She cracks a smile as the cogs in her head turn. "Maybe I should print it and put it on the bulletin board."</p>
    <p>"Then maybe people would actually read it."</p>
    <p>We walk down to our next class, across the whole building, lugging computers that barely work. They're not broken or anything; that's just how much the school cares. They can run Google Chrome half-decently and nothing else. We can't even really use Chrome, 'cause half the Internet is blocked "because the school has to keep us safe" like I haven't done things that would make the IT department close their eyes, clasp their hands and pray I get forgiven for my sins.</p>
    <p>Like they don't call my existence one.</p>
    <p>That's something I never got. Why am I "unnatural"? What makes me different from "normal" people? Is it my functioning brain?</p>
    <p>I can't understand the people who tell me to respect the body God gave me. If God really loved us, would I have been born differently? Would we suffer? If I "respected" the body God gave me, would I have been magically cured of my dysphoria and suicidal mindset?</p>` +
    // <p>The old man in the sky has either left us, never existed in the first place, or is a sadistic and hateful piece of shit.</p>
    // left off here last time I read it \/
    `<p>Or did God ever love us in the first place?</p>
    <p>"You good?" Des looks at me with that horrible mix of care and careful that makes me want to punch something. I would rather try to string myself up than have <i>her,</i> of all people, be careful with me.</p>
    <p>She knows that too. The fact that she doesn't pry when I tell her I'm fine is amazing; anybody else would have tried to make sure I'm <i>really</i> okay, that I don't need anything, that I have to yell in their face to get them to mind their own goddamn business.</p>
    <p></p>
    <p></p>
    <p></p>
    <p></p>
